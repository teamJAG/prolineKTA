    ...
    if (this.props.type !== prevProps.type || this.props.filter !== prevProps.filter) {
      switch (this.props.type) {
        case "keys":
          ...
          fetchRecordData(this.props.type, this.state.page, this.state.pageSize, this.state.sorted, this.props.filter, (res) => {
            this.setState({
              data: res.data,
              page: 0,
              pages: res.pages,
      ...
      <div>
        <ReactTable
          ...
          onFetchData={(state, instance) => {
            ...
            fetchRecordData(this.props.type, state.page, state.pageSize, state.sorted, this.props.filter, (res) => {
            this.setState({
              data: res.data,
              page: state.page,
              pages: res.pages,
