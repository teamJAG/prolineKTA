            ...
            <Segment>
              <Form>
                ...
                <Form.Field>
                  ...
                  <input type="text" id="contractor"></input>
                </Form.Field>
                ...
                <Form.Field>
                  <div class="four fields">
                    <div class="field">
                      ...
                      <Checkbox radio label='To Keep' name='checkboxRadioGroup' value='keep' checked={this.state.value === 'keep'} onChange={this.handleChange}/>
                      </div>
                      <div class="field"><br/><br/>
                      <Checkbox radio label='Purchase' name='checkboxRadioGroup' value='purchase' checked={this.state.value === 'purchase'} onChange={this.handleChange}/>
                    </div>
                    <div class="field">
                      <label>Deposit</label>
